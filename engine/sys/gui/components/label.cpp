	...
	: engine::gui::base(par_layout)
{
	...
	wchar_t *text = L"Hello World! Man, this text rendering kinda works doesn't it?";
	...
	for(i = 0; i < wcslen(text); ++i) {
		...
		if( glyph != NULL )
		{
		    ...
		    float y0  = (int)( pen.y + glyph->height + (m_font->ascender - glyph->offset_y));
		    ...
		    vertex_t vertices[4] = { { x0,y0,0,  s0,t1,  r,g,b,a },
			                     { x0,y1,0,  s0,t0,  r,g,b,a },
